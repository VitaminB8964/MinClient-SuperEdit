...
import cn.floatingpoint.min.system.module.impl.boost.impl.AutoClicker;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    private void clickMouse() {
        if (Managers.moduleManager.boostModules.get("AutoClicker").isEnabled() && new AutoClicker().left.getValue()){
            this.leftClickCounter = 0;
        }
